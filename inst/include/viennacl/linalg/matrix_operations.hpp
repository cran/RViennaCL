...
#define VIENNACL_MAKE_UNARY_ELEMENT_OP(funcname) \
    ...
    VIENNACL_MAKE_UNARY_ELEMENT_OP(acosh)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(asin)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(asinh)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(atan)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(atanh)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(ceil)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(cos)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(cosh)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(erf)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(erfc)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(exp)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(exp2)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(exp10)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(fabs)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(floor)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(log)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(log2)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(log10)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(round)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(rsqrt)
    VIENNACL_MAKE_UNARY_ELEMENT_OP(sign)
    ...
    VIENNACL_MAKE_UNARY_ELEMENT_OP(trunc)

  ...
  inline std::string to_string(viennacl::scheduler::op_element op_elem)
  {
    if (op_elem.type_family == OPERATION_UNARY_TYPE_FAMILY)
    {
      ...
      VIENNACL_TRANSLATE_OP_TO_STRING(OPERATION_UNARY_ABS_TYPE)
          ...
          VIENNACL_TRANSLATE_OP_TO_STRING(OPERATION_UNARY_ACOSH_TYPE)
          VIENNACL_TRANSLATE_OP_TO_STRING(OPERATION_UNARY_ASIN_TYPE)
          VIENNACL_TRANSLATE_OP_TO_STRING(OPERATION_UNARY_ASINH_TYPE)
          VIENNACL_TRANSLATE_OP_TO_STRING(OPERATION_UNARY_ATAN_TYPE)
          VIENNACL_TRANSLATE_OP_TO_STRING(OPERATION_UNARY_ATANH_TYPE)
          ...
          VIENNACL_TRANSLATE_OP_TO_STRING(OPERATION_UNARY_ERF_TYPE)
          VIENNACL_TRANSLATE_OP_TO_STRING(OPERATION_UNARY_ERFC_TYPE)
          VIENNACL_TRANSLATE_OP_TO_STRING(OPERATION_UNARY_EXP_TYPE)
          VIENNACL_TRANSLATE_OP_TO_STRING(OPERATION_UNARY_EXP2_TYPE)
          VIENNACL_TRANSLATE_OP_TO_STRING(OPERATION_UNARY_EXP10_TYPE)
          ...
          VIENNACL_TRANSLATE_OP_TO_STRING(OPERATION_UNARY_LOG2_TYPE)
          VIENNACL_TRANSLATE_OP_TO_STRING(OPERATION_UNARY_LOG10_TYPE)
          VIENNACL_TRANSLATE_OP_TO_STRING(OPERATION_UNARY_ROUND_TYPE)
          VIENNACL_TRANSLATE_OP_TO_STRING(OPERATION_UNARY_RSQRT_TYPE)
          VIENNACL_TRANSLATE_OP_TO_STRING(OPERATION_UNARY_SIGN_TYPE)
          ...
          VIENNACL_TRANSLATE_OP_TO_STRING(OPERATION_UNARY_TRUNC_TYPE)
